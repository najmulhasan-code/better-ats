...
export default function Hero() {
  ...
  // Mouse position tracking for parallax and 3D effects
  useEffect(() => {
            ...
            >
              <div className="group relative bg-white/70 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-teal-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl mb-4 flex items-center justify-center transform group-hover:rotate-6 transition-transform duration-300">
              ...
              <div className="group relative bg-white/70 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-cyan-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-sky-500 rounded-xl mb-4 flex items-center justify-center transform group-hover:rotate-6 transition-transform duration-300">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="group relative bg-white/70 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-sky-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-gradient-to-br from-sky-500 to-teal-500 rounded-xl mb-4 flex items-center justify-center transform group-hover:rotate-6 transition-transform duration-300">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className={`space-y-6 ${isVisible('video-interview') ? 'animate-slide-in-left' : ''}`}>
                <div className="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold mb-4 animate-pulse-slow">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                    <div className="text-3xl animate-bounce-slow" style={{ animationDelay: '0.2s' }}>🛡️</div>
                    <div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              { icon: '🎯', title: 'Smart Matching', desc: 'AI analyzes skills, experience, and cultural fit', color: 'from-teal-500 to-cyan-500' },
              { icon: '📊', title: 'Analytics Dashboard', desc: 'Real-time insights into your hiring pipeline', color: 'from-cyan-500 to-sky-500' },
              { icon: '🤖', title: 'Automated Screening', desc: 'Save time with intelligent resume parsing', color: 'from-sky-500 to-teal-500' },
              { icon: '🎥', title: 'AI Video Interviews', desc: '2-minute video interviews filter bots automatically', color: 'from-teal-500 to-cyan-500', highlight: true },
              { icon: '🔒', title: 'Secure & Compliant', desc: 'Enterprise-grade security and privacy', color: 'from-cyan-500 to-sky-500' },
              { icon: '⚡', title: 'Lightning Speed', desc: 'Process hundreds of applications in minutes', color: 'from-sky-500 to-teal-500' },
            ].map((feature, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="text-5xl mb-4 transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">{feature.icon}</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="space-y-12">
              {[
                { step: '01', title: 'Upload & Parse', desc: 'Simply upload resumes or connect your job boards. Our AI instantly parses and extracts key information.', icon: '📄' },
                { step: '02', title: 'AI Video Interview', desc: 'Applicants complete a 2-minute AI video interview. This automatically filters out bots and low-quality applications.', icon: '🎥', highlight: true },
                { step: '03', title: 'AI Analysis & Matching', desc: 'Advanced algorithms analyze video responses, skills, experience, and cultural fit to create comprehensive candidate profiles.', icon: '🤖' },
                { step: '04', title: 'Interview & Hire', desc: 'Schedule interviews, track feedback, and make data-driven hiring decisions all in one platform.', icon: '✅' },
              ].map((item, idx) => (
                <div
                  key={idx}
                ...
                >
                  ...
                  <div className="flex-shrink-0 relative z-10">
                    ...
                    <div className="absolute -top-2 -right-2 text-3xl animate-bounce-slow">{item.icon}</div>
                  </div>
